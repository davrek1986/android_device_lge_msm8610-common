...
BOARD_KERNEL_CMDLINE := console=ttyHSL0,115200,n8 androidboot.console=ttyHSL0 androidboot.hardware=msm8916 user_debug=31 msm_rtb.filter=0x37 androidboot.selinux=permissive
